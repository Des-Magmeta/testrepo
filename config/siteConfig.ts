...
export const siteConfig: SiteConfig = {
	...
	site_url: "https://des-magmeta.github.io",
	description:
		"Des Magmeta 正在进行网站测试",
	keywords: [
		"Des-Magmeta",
		"Design",
		"博客",
	...
	navbarTitle: "Nakadai Magmeta", // 导航栏标题，可以设置为与 title 不同的值，如果不设置则使用 title
	...
	backgroundWallpaper: {
		...
		banner: {
			...
			homeText: {
				...
				// 主页横幅副标题
				subtitle: [
					"Font otakus save the world!",
					"字体设计一定要研究字体！",
					"拒绝巾川华文审美，从你我做起。",
					"打破泛中日韩字体「不可能三角」一定要实现！",
					"字因你太美。Fonts are full of diverse with our effort.",
